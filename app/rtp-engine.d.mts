...
export type RtpWager = { roleId: RtpRoleId; stake: number; target: number; manual?: boolean };
...
export type DuoSettlement = { extras: number[]; total: number; note: string; title: string; triggered: boolean; sourceIndexes: number[]; description: DuoDescription | null };
